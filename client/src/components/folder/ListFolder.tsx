...
import { deleteFolder, createFolder } from '../../redux/actions/folderActions';
...
const ListFolder = ({ folders, deleteFolder, createFolder, user }: any) => {
...
const mapDispatchToProps = (dispatch: any) => {
    return {
        ...
        createFolder: (token: string, input: CreateFolderInput, addToast: any) => dispatch(createFolder(token, input, addToast))
    }
}
