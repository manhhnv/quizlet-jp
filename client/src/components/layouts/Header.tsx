    ...
    return (
        <React.Fragment>
            <Row className="header">
                ...
                <div>
                    <FaSearch></FaSearch>
                    <span style={{paddingLeft: "15px"}} className="header__sub-item">Search</span>
                </div>
                <div>
                    <FaRegCalendarPlus></FaRegCalendarPlus>
                    <span style={{paddingLeft: "15px"}} className="header__sub-item">Create</span>
                </div>
                <div className="header__button">
                    <Button className="header__button--login">Login</Button>
                    <Button className="header__button--register" autoFocus>Register</Button>
                </div>
            </Row>
        </React.Fragment>
    )
